...
def _work_dir(manager: ProjectManager, exp_id: str, data_id: str) -> Path:
    """每数据独立工作目录:processing/<exp_id>/<data_id>/。"""
    return manager.dir_path("processing") / exp_id / data_id
...
def generate_spectrum(
    ...
    *,
    ...
    spectrum_path = str(resp.get("spectrum_path", ""))
    manager.set_data_spectrum(exp_id, data_id, spectrum_path)
    _finish_step(
        manager,
        exp_id,
        data_id,
