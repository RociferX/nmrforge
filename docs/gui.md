...
```bash
python main.py    # v0.11.0 source entry point (the AppImage starts it internally)
```

The v0.11.0 Linux AppImage is on the releases page (one artefact, interface language switched at
run time); the first
