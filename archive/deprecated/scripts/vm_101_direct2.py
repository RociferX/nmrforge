"""101:首遍 SMILE(更窄直接维窗 7-10)→ 实型 finalize → 直接维搜索。"""
...
def main() -> int:
    raw = Path("/home/<lab-user>/Desktop/sampleJ")
    work = Path("/home/<lab-user>/Desktop/sampleJ.nmrpipe")
    ...
    print("SMILE 首遍重构中(直接维窗口 7.0-10.0 ppm)...")
    ...
    resp = backend.finalize_nus(
        ...
        out_file="101_direct_final.ft3",
        script_name="101_direct_final_finalize.com",
    )
    ...
    print("101 实型终谱 shape:", arr.shape)
