...
| pipe2xyz -out nus3d_1_r300/test%04d.ft1 -z
xyz2pipe -in nus3d_1_r300/test%04d.ft1 -x \
| nmrPipe -fn SMILE -nDim 3 \
           ...
           -yAlt -maxMem 6 \
           -thresh 0.95 \
| pipe2xyz -out nus3d_rc_r300/test%04d.ft1 -x
echo REAL300_DONE
...
| nmrPipe -fn SMILE -nDim 3 \
           ...
           -yAlt -maxMem 6 \
           -thresh 0.95 \
| pipe2xyz -out nus3d_rc_imag300/test%04d.ft1 -x
echo IMAG300_DONE
