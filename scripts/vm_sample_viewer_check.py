"""Architect VM 回归:用 viewer 的 Spectrum 轴换算对比软件/手工谱(sampleA)。"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if opts.noext:
        ...
        # 水峰 4.7 ppm 列(data 形状 = [15N 行, 1H 列])
        ...
        print(f"  1H 列(竖线候选) energy={col_energy:.3e} peak={col_peak:.3e} | "
              f"15N 行 energy={row_energy:.3e} peak={row_peak:.3e}")
